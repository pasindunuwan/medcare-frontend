...
export default function RegistrationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name || !email || !phone || !nic || !password || !repassword) {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:3000/api/registerPatient", {
        name,
        email,
        phone,
        nic,
  ...
  return (
    ...
    <div className=' flex w-8/12 bg-white mx-auto overflow-hidden '>
                  <div className=' w-1/2 flex flex-col justify-center' > 
                    <h2 className='mb-8 mr-2-2 text-2xl md:text-3xl lg:text-4xl xl:text-5xl 
                                    font-extrabold'>Registration <br/> for <br/> Patient</h2>
                    <dev className=' mr-5 text-lg md:xl lg:2xl'>
                      <p>Join <b>MedCare</b> to easily manage your records.</p>
                    </dev>
                  </div>
    <div className=' w-1/2  bg-black text-white py-8 px-8'>
        <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="nic" className="block text-sm font-medium text-white-700">
                NIC:
              </label>
              <input
                id="nic"
